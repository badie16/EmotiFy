...
export async function analyzeEmotion(text) {
	try {
		console.log("Envoi de la requête à:", `${API_URL}/api/text/analyze`);
		console.log("Texte à analyser:", text);

		const response = await axios.post(`${API_URL}/api/text/analyze`, { text });
...
export async function saveAnalysis(analysisData) {
	try {
		const response = await axios.post(`${API_URL}/api/text/history`, analysisData);
		return response.data;
	} catch (error) {
...
export async function getAnalysisHistory() {
	try {
		const response = await axios.get(`${API_URL}/api/text/history`);
		return response.data;
	} catch (error) {
...
export async function deleteAnalysis(id) {
	try {
		const response = await axios.delete(`${API_URL}/api/text/${id}`);
		return response.data;
	} catch (error) {
